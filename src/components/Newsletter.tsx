      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            Stay Updated with the Latest Casino Bonuses
          </h2>
          <p className="text-[#a4a5b0] text-lg mb-8">
            Get exclusive bonus codes, new casino reviews, and special offers delivered straight to your inbox. Never miss out on the best crypto casino deals!
          </p>
